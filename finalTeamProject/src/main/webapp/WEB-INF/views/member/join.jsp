...
// 				if(radio.checked)favoriteTeam = radio.value
// 			})
// 			const ob = {
...
// 				mainPosition : event.target.querySelector('select[name="mainPosition"]').value,
// 				subPosition : event.target.querySelector('select[name="subPosition"]').value,
// 				grade : event.target.querySelector('input[name="grade"]').value,
// 				locked : event.target.querySelector('input[name="locked"]').value,
// 			}
			const opt = {
					method: 'POST',
					body: formData,
